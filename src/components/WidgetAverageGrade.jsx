...
function WidgetAverageGrade({ visible = false }) {
  ...
  return (
    <article
      className={`average-grade-widget widget-card shadow-md flex-[0_1_220px] h-[148px] p-5 border border-white rounded-[1.75rem] overflow-hidden bg-widget-bg text-base leading-6 min-w-0 max-2xl:flex-[1_1_calc(50%-7px)] max-2xl:min-w-0 max-md:h-[132px] max-md:p-4 max-md:rounded-3xl flex flex-col gap-[6px] text-text cursor-pointer relative ${visible ? 'widget-card-visible delay-[280ms]' : ''}`}
